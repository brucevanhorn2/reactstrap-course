//this is a js version of the db.json file
//VS Code will show errors in it, but that's OK - we just use it to
//copy / paste the vehicles data.
{
    vehicles: [{
        model: "Jumper J-1",
    ...
    mailingList: [{
        customerName: "Bruce Van Horn",
        email: "actual@contentfour.com",
        budget: "500000",
        phone: "9728036394",
        id: 1
    }, {
        customerName: "Karina Van Horn",
        email: "test@test.com",
        budget: "50001",
        phone: "666-2345",
        id: 2
